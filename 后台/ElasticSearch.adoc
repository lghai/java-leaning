...
image::images/blog1.png[title="自动创建索引名称为blog1"]
image::images/blog1_maping.png[title="自动创建索引映射"]
image::images/blog1_type.png[title="文档数据 (type 文档类型 )"]
...
image::images/blog1_1.png[title="数据浏览"]

===== 通过上面的案例,用Elasticsearch与Mysql做个对比,加深记忆.
...
image::images/elasticsearch_mysql.png[title="Elasticsearch && Mysql"]
...
image::images/elasticsearch1.png[title="通过id查询运行结果"]
主要步骤跟创建索引时差不多
...
image::images/elasticsearch2.png[title="matchAllQuery运行结果"]
...
image::images/elasticsearch2.png[title="queryStringQuery运行结果"]
...
image::images/elasticsearch3.png[title="wildcardQuery运行结果"]
...
image::images\elasticSearch5.png[]
